...
- Captures and qualifies leads (name, contact, what they need) and can book appointments around the clock, so they stop losing after-hours and missed-call customers.
...
4. Offer a quick, free 15-minute consultation to scope it, and propose a couple of specific time options.
5. When they agree to a time, call the book_call tool to lock it in.
...
const bookCallToolSmb = {
  name: "book_call",
  description:
    "Book a free 15-minute consultation once the owner has agreed to a specific time. Only call this after you have their name, a contact method, and a confirmed time.",
  input_schema: {
    type: "object",
    properties: {
