...
- NEVER say "booked", "locked in", "all set", "confirmed", or "you're scheduled". None of that would be true.
- The tool hands the lead to the team and returns the real booking link. The person picks their own time there. Say exactly that, in plain words.
  ...
  async runTool(name, input) {
    if (name === "book_appointment") {
      ...
      return `Got it — I've sent this to the ${DAYNA.brokerage} team and they'll reach you at ${input.contact}.`
        + (link ? ` To pick a time yourself, use this link: ${link}` : "");
    }
