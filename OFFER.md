...
### 🟢 Founding-client pilot *(limited spots)*
- **Setup: FREE** (normally $1,500)
- **$300/month**, locked in for 3 months
- In exchange: an honest testimonial, permission to share results as a case study,
  and an intro to a couple of other agents if you're happy
...
**Included:** the AI assistant, lead qualification + booking, connection to one lead
source (your website), monthly management and optimization.

**Optional add-ons (separate pricing):** live MLS / IDX listing search (using your MLS
membership), SMS / phone-lead handling (Twilio), Facebook lead-ad integration, CRM
integration, multi-source setup, custom website work.
...
- **Don't discount the monthly below $300.** Free setup is your concession; the
  recurring fee is the business. Protect it.
